...
std::unordered_map<UnitType, sf::Texture>
    ResourceManager::m_animation_sprite_sheets{};
std::unordered_map<UnitType, int>
    ResourceManager::m_amount_of_sprites_in_animation{};
...
void ResourceManager::load_resources() {
    ...
    ResourceManager::m_animation_sprite_sheets[UnitType::Type1].loadFromFile(
        interface::source_dir + "units_attack/unit_attack_type1.png"
    );
    ResourceManager::m_animation_sprite_sheets[UnitType::Type2].loadFromFile(
        interface::source_dir + "units_attack/unit_attack_type2.png"
    );
    ResourceManager::m_animation_sprite_sheets[UnitType::Type3].loadFromFile(
        interface::source_dir + "units_attack/unit_attack_type3.png"
    );
    ResourceManager::m_animation_sprite_sheets[UnitType::Type4].loadFromFile(
        interface::source_dir + "units_attack/unit_attack_type2.png"
    );
    ResourceManager::m_animation_sprite_sheets[UnitType::Type5].loadFromFile(
        interface::source_dir + "units_attack/unit_attack_type3.png"
    );

    ResourceManager::m_amount_of_sprites_in_animation[UnitType::Type1] = 4;
    ResourceManager::m_amount_of_sprites_in_animation[UnitType::Type2] = 4;
    ResourceManager::m_amount_of_sprites_in_animation[UnitType::Type3] = 4;
    ResourceManager::m_amount_of_sprites_in_animation[UnitType::Type4] = 4;
    ResourceManager::m_amount_of_sprites_in_animation[UnitType::Type5] = 4;
...
const sf::Texture &ResourceManager::load_animation_sprite_sheet(UnitType texture
) {
    load_resources();
...
int ResourceManager::amount_of_frames_in_animation(UnitType type) {
    load_resources();
